...
I don't know if I didn't understand. But I'm not totaly agree with co.scan. IMHO I think that the pricing_rules must be calculated in method total

I wrote this code much simple as I could ;)
...
After the prompt I wanted to run the test suite ../spec/main_spec.rb, to validate your answers
